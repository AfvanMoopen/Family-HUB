...
class AccountTest extends FeatureTestCase
{
    ...
    public function user_is_subscribed_returns_true_if_monthly_plan_is_set()
    {
        ...
        config(['test.paid_plan_monthly_friendly_name' => 'fakePlan']);
    ...
    public function user_is_subscribed_returns_true_if_annual_plan_is_set()
    {
        ...
        config(['test.paid_plan_annual_friendly_name' => 'annualPlan']);
    ...
    {
        config([
            'test.paid_plan_annual_friendly_name' => 'fakePlan',
            'test.paid_plan_annual_id' => 'chandler_5',
        ]);
