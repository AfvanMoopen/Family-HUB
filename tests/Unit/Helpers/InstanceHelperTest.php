...
class InstanceHelperTest extends TestCase
{
    ...
    {
        config(['test.paid_plan_monthly_friendly_name' => 'Monthly']);
        config(['test.paid_plan_monthly_id' => 'monthly']);
        config(['test.paid_plan_monthly_price' => 1000]);
    ...
    {
        config(['test.paid_plan_annual_friendly_name' => 'Annual']);
        config(['test.paid_plan_annual_id' => 'annual']);
        config(['test.paid_plan_annual_price' => 1000]);
