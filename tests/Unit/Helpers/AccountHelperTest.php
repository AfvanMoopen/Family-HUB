...
class AccountHelperTest extends TestCase
{
    ...
    public function user_has_limitations_if_not_subscribed_or_exempted_of_subscriptions(): void
    {
        ...
        config(['test.requires_subscription' => false]);
    ...
    public function account_has_reached_contact_limit_on_free_plan(): void
    {
        ...
        config(['test.number_of_allowed_contacts_free_account' => 1]);
        $this->assertTrue(
        ...
        config(['test.number_of_allowed_contacts_free_account' => 3]);
        $this->assertFalse(
            AccountHelper::hasReachedContactLimit($account)
        );

        config(['test.number_of_allowed_contacts_free_account' => 100]);
        $this->assertFalse(
            AccountHelper::hasReachedContactLimit($account)
        );
