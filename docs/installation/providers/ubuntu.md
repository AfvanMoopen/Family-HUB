# Installing test on Ubuntu <!-- omit in toc -->

<img alt="Ubuntu" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Logo-ubuntu_cof-orange-hex.svg/120px-Logo-ubuntu_cof-orange-hex.svg.png" width="120" height="120" />

test can run on [Ubuntu 18.04 (Bionic Beaver)](http://releases.ubuntu.com/18.04/).
...
You may install test by simply cloning the repository. In order for this to work with Apache, you need to clone the repository in a specific folder:
...
test requires some background processes to continuously run. The list of things test does in the background is described [here](https://github.com/testhq/test/blob/master/app/Console/Kernel.php#L33).
