...
@section('content')
  <div class="dashboard">
    ...
    <section class="ph3 ph5-ns pv4 cf w-100 bg-gray-test">
    ...
    {{-- Main section --}}
    <section class="ph3 ph5-ns cf w-100 bg-gray-test">
      <div class="mw9 center">
        <div class="{{ htmldir() == 'ltr' ? 'fl' : 'fr' }} w-50-ns w-100 pa2">
          <div class="br3 ba b--gray-test bg-white mb4">
            <div class="pa3 bb b--gray-test">
              <p class="mb0">
                📅
