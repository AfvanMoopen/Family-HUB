      ...
      <div class="col-12 col-sm-9">
        ...
        <div class="br3 ba b--gray-test bg-white mb4">
          <div class="pa3 bb b--gray-test">
            ...
            <p>{!! trans('settings.export_sql_link_instructions', ['url' => 'https://github.com/testhq/test/blob/master/docs/installation/update.md#importing-sql-from-the-exporter-feature']) !!}</p>
          </div>
        </div>
