    ...
    <div class="{{ Auth::user()->getFluidLayout() }}">
      <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2">
            ...
            <div class="pa4 bb b--gray-test">
              ...
              <div class="cf mb4">
                ...
                <div class="{{ htmldir() == 'ltr' ? 'fl' : 'fr' }} w-50-ns w-100 pa3">
                  <div class="b--gray-test ba pt3 br3 bw1">
          ...
          <p class="mb4">{{ trans('settings.subscriptions_help_limits_plan', ['number' => config('test.number_of_allowed_contacts_free_account')]) }}</p>
