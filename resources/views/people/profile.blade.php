    ...
    <div class="{{ Auth::user()->getFluidLayout() }}">
      ...
      <div class="row">
        <div class="col-12 col-sm-3 profile-sidebar">
          ...
          @if (! is_null($weather))
          <div class="ba b--near-white br2 bg-gray-test pa3 mb3 f6">
            <div class="w-100 dt">
              <div class="dtc">
        ...
        <div class="col-12 col-sm-9">
          ...
          <div class="flex items-center justify-center flex-column">
            <div class='cf dib'>
              @if (! $contact->isMe())
              <span @click="updateDefaultProfileView('life-events')" :class="[global_profile_default_view == 'life-events' ? 'f6 fl bb bt br bl ph3 pv2 dib b br2 br--left bl mb4 b--gray-test' : 'f6 fl bb bt br ph3 pv2 dib bg-gray-test br2 br--left bl pointer mb4 b--gray-test']">
              ...
              @endif
              <span @click="updateDefaultProfileView('notes')" :class="[global_profile_default_view == 'notes' ? 'f6 fl bb bt ph3 pv2 dib b br--right br mb4 b--gray-test' : 'f6 fl bb bt ph3 pv2 dib bg-gray-test br--right br pointer mb4 b--gray-test']">{{ trans('people.life_event_list_tab_other') }}</span>
              <span @click="updateDefaultProfileView('photos')" :class="[global_profile_default_view == 'photos' ? 'f6 fl bb bt ph3 pv2 dib b br2 br--right br mb4 b--gray-test' : 'f6 fl bb bt ph3 pv2 dib bg-gray-test br2 br--right br pointer mb4 b--gray-test']">Photos</span>
            </div>
          </div>
