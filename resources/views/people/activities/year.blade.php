...
@section('content')
{{-- Breadcrumb --}}
<section class="ph3 ph5-ns pt4 cf w-100 bg-gray-test">
  <div class="mw7 center">
    <div class="full-page-modal-header ph4 pv3 bt br bl b--gray-test">
      <ul>
...
{{-- Main section --}}
<section class="ph3 ph5-ns cf w-100 bg-gray-test mb5">
  <div class="mw8 center full-page-modal pt4">
    <h2 class="tc bb b--gray-test pb4 mb3 normal">{{ trans('people.activities_profile_title', ['name' => $contact->first_name]) }}</h2>
    ...
    <div class="cf ph2-ns">
      ...
      <div class="fl w-100 w-75-ns pa2">
        <div class="bg-white">
          ...
          {{-- Bar chart --}}
          <div class="ba b--gray-test mb5-ns mb6 br2">
          ...
          <div class="pl2 bl-ns b--gray-test">
