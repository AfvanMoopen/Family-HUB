  ...
  <div>
    ...
    <transition name="fade">
      <div class="ba br3 mb3 pa3 b--black-40">
        ...
        <!-- ADDITIONAL FIELDS -->
        <div v-show="!displayDescription || !displayEmotions || !displayCategory || !displayParticipants" class="bb b--gray-test pv3 mb3">
          <ul class="list">
        ...
        <!-- DESCRIPTION -->
        <div v-if="displayDescription" class="bb b--gray-test pv3 mb3">
          <form-textarea
        ...
        <!-- EMOTIONS -->
        <div v-if="displayEmotions" class="bb b--gray-test pb3 mb3">
          <label>
        ...
        <!-- ACTIVITY CATEGORIES -->
        <div v-if="displayCategory" class="bb b--gray-test pb3 mb3">
          <activity-type-list
        ...
        <!-- PARTICPANTS -->
        <div v-if="displayParticipants" class="bb b--gray-test pb3 mb3">
          <label>
