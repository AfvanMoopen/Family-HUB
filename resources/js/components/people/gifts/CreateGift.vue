  ...
  <div>
    ...
    <transition name="fade">
      <div class="ba br3 mb3 pa3 b--black-40">
        <div class="pb3 mb3 flex-ns b--gray-test">
          <!-- STATUS -->
          <form-radio
            :id="'status_idea'"
        ...
        <div class="dt dt--fixed pb3 mb3 mb0-ns bb b--gray-test">
          <!-- NAME -->
          <form-input
            :id="'name'"
        ...
        <!-- ADDITIONAL FIELDS -->
        <div v-show="displayMenu" class="bb b--gray-test pv3 mb3">
          <ul class="list">
        ...
        <div v-if="displayComment" class="dt dt--fixed pb3 mb3 bb b--gray-test">
          <!-- COMMENT -->
          <form-input
            :id="'comment'"
        ...
        <div v-if="displayUrl" class="dt dt--fixed pb3 mb3 bb b--gray-test">
          <!-- URL -->
          <form-input
            :id="'url'"
            v-model="newGift.url"
        ...
        <div v-if="displayAmount" class="dt dt--fixed pb3 mb3 bb b--gray-test">
          <!-- AMOUNT -->
          <form-input
            :id="'amount'"
        ...
        <div v-if="displayRecipient" class="dt dt--fixed pb3 mb3 bb b--gray-test">
          <!-- RECIPIENT -->
          <form-checkbox
        ...
        <div v-show="displayUpload" class="dt dt--fixed pb3 mb3 bb b--gray-test">
          <span class="mb2 b">
          ...
          <div v-show="photos.length > 0">
            <div class="flex flex-wrap">
              <div v-for="photo in photos" :key="photo.id" class="w-third-ns w-100">
                <div v-if="photo.id > 0" class="pa2 mb3 br2 ba b--gray-test" :class="dirltr ? 'mr3' : 'ml3'">
                  <div class="cover bg-center photo w-100 h-100 br2 bb b--gray-test pb2"
