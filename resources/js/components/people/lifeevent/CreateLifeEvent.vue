...
<template>
  <section class="ph3 ph0-ns life-event">
    ...
    <div class="mt4 mw7 center mb3">
      <!-- Breadcrumb -->
      <ul v-if="view == 'types' || view == 'add'" class="ba b--gray-test pa2 mb2">
        <li class="di">
      ...
      <!-- List of events -->
      <ul v-if="view != 'add'" class="ba b--gray-test br2">
        <template v-if="view == 'categories'">
          <!-- CATEGORIES -->
          <li v-for="category in categories" :key="category.id" class="relative pointer bb b--gray-test b--gray-test pa2 life-event-add-row" @click="getType(category)">
            <div class="dib mr2">
        ...
        <template v-else-if="view == 'types'">
          <!-- TYPES -->
          <li v-for="type in types" :key="type.id" class="relative pointer bb b--gray-test b--gray-test pa2 life-event-add-row" @click="displayAddScreen(type)">
            <div class="dib mr2">
      ...
      <!-- ADD SCREEN -->
      <div v-else class="ba b--gray-test br2 pt4">
        ...
        <div class="ph4 pv3 mb3 mb0-ns bb b--gray-test">
        ...
        <!-- FORM ACTIONS -->
        <div class="ph4-ns ph3 pv3 bb b--gray-test">
