...
<template>
  <div class="pa4-ns ph3 pv2 bb b--gray-test">
    ...
    <div class="mb3 mb0-ns">
      ...
      >
        ...
        <div slot="extra">
          <img class="mb4 pa2 ba b--gray-test br3" style="width: 150px" :src="defaultUrl" alt="" />
        </div>
      </form-radio>
      ...
      >
        ...
        <div slot="extra">
          <img class="mb4 pa2 ba b--gray-test br3" style="width: 150px" :src="adorableUrl" alt="" />
        </div>
      </form-radio>
      ...
      >
        ...
        <div slot="extra">
          <img class="mb4 pa2 ba b--gray-test br3" style="width: 150px" :src="gravatarUrl" alt="" />
        </div>
      </form-radio>
      ...
      >
        ...
        <div slot="extra">
          <img class="mb4 pa2 ba b--gray-test br3" style="width: 150px" :src="photoUrl" alt="" />
        </div>
      </form-radio>
      ...
      >
        ...
        <div slot="extra">
          ...
          <img v-if="croppedImgUrl" class="mb4 pa2 ba b--gray-test br3" style="width: 150px" :src="croppedImgUrl" alt="" />
        </div>
      </form-radio>
    </div>
