...
<template>
  <div class="br3 ba b--gray-test bg-white mb3">
    <notifications group="main" position="bottom right" width="400" />

    <div class="pa3 bb b--gray-test tc">
      <ul>
    ...
    <div class="pa4">
      ...
      <div v-if="activeTab == 'tasks'">
        ...
        <!-- Tasks: Create task -->
        <div v-show="taskAddMode" class="br3 pa2 ba b--gray-test mb3">
          <div class="flex items-center mb2">
            <input type="checkbox" disabled class="di mr2 pb2" />
            <input v-model="newTask.title" type="text" class="bt-0 br-0 bl-0 w-100 di bb b--gray-test pt2 pb2" :placeholder="$t('dashboard.tasks_add_task_placeholder')" @keyup.enter="saveTask()"
