...
<template>
  <div class="mw9 center">
    ...
    <div :class="[ dirltr ? 'fl' : 'fr' ]" class="w-70-ns w-100 pa2">
      ...
      <div v-if="(journalEntries.per_page * journalEntries.current_page) <= journalEntries.total" class="br3 ba b--gray-test bg-white pr3 pb3 pt3 mb3 tc">
      ...
      <div v-if="journalEntries.total === 0" v-cy-name="'journal-blank-state'" class="br3 ba b--gray-test bg-white pr3 pb3 pt3 mb3 tc">
        <div class="tc mb4">
