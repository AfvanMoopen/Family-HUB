...
return [
    ...
    'me_help' => 'Это контакт, который представляет <em>вас</em> в test',
    ...
    'export_sql_explanation' => 'Экспорт данных в формате SQL позволяет импортировать данные в свой собственный экземпляр test. Это ценно, только если у вас есть собственный сервер.',
    ...
    'locale' => 'Язык',
    'locale_help' => 'Хотите помочь с переводом test или добавить новый язык? Перейдите по <a href=":url" target="_blank" lang="en">этой ссылке для получения дополнительной информации</a>.',
    'locale_ar' => 'Арабский',
    'locale_cs' => 'Чешский',
    'locale_de' => 'Немецкий',
    ...
    'api_description' => 'API может использоваться для работы с данными test из внешнего приложения, например – мобильного приложения.',
    ...
    'api_endpoint' => 'Конечная точка API для этого экземпляра test:',
