...
return [
    ...
    'me_title' => 'Kişilerim',
    'me_help' => 'Bu hesap test\'da <em>sizi</em> temsil eden kişidir',
    ...
    'export_sql_explanation' => 'Verilerinizi SQL formatında dışa aktarmak, verilerinizi alıp kendi test örneğinizde içe aktarmanıza olanak tanır. Bu, yalnızca kendi sunucunuz varsa değerlidir.',
    ...
    'locale_help' => 'test\'yı çevirmeye yardım etmek veya yeni bir dil eklemek ister misiniz? Lütfen <a href=":url" target="_blank" lang="en">daha fazla bilgi için bu linki</a> takip edin.',
    'locale_ar' => 'Arapça',
    'locale_cs' => 'Çekçe',
    'locale_de' => 'Almanca',
    'locale_en' => 'İngilizce',
    ...
    'users_list_invitations_explanation' => 'Birlikte çalışmak için test\'ya katılmaya davet ettiğiniz kişiler aşağıdadır.',
    ...
    'subscriptions_account_upgrade_title' => 'test\'yı bugün yükseltin ve daha anlamlı ilişkilere sahip olun.',
    'subscriptions_account_upgrade_choice' => 'Aşağıdaki planlardan birini seçin ve test\'larını yükselten :customers üzerinde kişinin arasına katılın.',
    ...
    'subscriptions_downgrade_thanks' => 'Ücretli planı denediğin için çok teşekkür ederiz. test\'ya sürekli yeni özellikler eklemeye devam ediyoruz – bu yüzden tekrar abonelik almakla ilgilenip ilgilenmeyeceğini görmek için gelecekte tekrar gelmek isteyebilirsin.',
    ...
    'subscriptions_help_discounts_desc' => 'Evet var! test öğrencilere ve kâr amacı gütmeyen kuruluşlara ücretsizdir. Sadece durumunuz ile ilgili bir kanıt ile birlikte <a href=":support">destek</a> ile iletişime geçin ve hesabınıza bu özel duruma uygun hale getirelim.',
    ...
    'api_description' => 'API, test’nın verilerini harici bir uygulamadan, örneğin bir mobil uygulama gibi, yönetmek için kullanılabilir.',
    ...
    'api_endpoint' => 'Bu test örneğinin API uç noktası:',
    ...
    'personalization_title' => 'Burada, hesabınızı yapılandırmak için farklı ayarlar bulabilirsiniz. Bu özellikler test üzerinde maksimum kontrol sahibi olmak isteyen “uzman kullanıcılar” içindir.',
