 ...
 *
 * @see https://github.com/testhq/test/blob/master/docs/contribute/translate.md for translations.
 */
...
return [
    ...
    'confirmation_email_title' => 'test – vérification d’adresse courriel',
    ...
    'password_reset_title' => 'test – Réinitialisation du mot de passe',
    ...
    'invitation_title' => 'test – Vous êtes invité par :name',
    'invitation_intro' => 'Vous avez été invité par :name (:email) à utiliser test, un outil de gestion de relations personnelles.',
