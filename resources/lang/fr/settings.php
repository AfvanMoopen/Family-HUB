...
return [
    ...
    'me_help' => 'Ceci est le contact qui <em>vous</em> représente sur test',
    ...
    'export_sql_explanation' => 'Exporter les données au format SQL vous permet de récupérer vos données et de les importer dans votre propre instance de test. Ceci n’a d’intérêt que si vous avez votre propre serveur.',
    ...
    'locale' => 'Langue',
    'locale_help' => 'Voulez-vous aider à traduire test ou ajouter une nouvelle langue ? Veuillez suivre <a href=":url" target="_blank" lang="en">ce lien pour plus d’informations</a>.',
    'locale_ar' => 'Arabe',
    'locale_cs' => 'Tchèque',
    'locale_de' => 'Allemand',
    'locale_en' => 'Anglais',
    ...
    'users_list_invitations_explanation' => 'Voici les personnes que vous avez invité à rejoindre test comme collaborateurs.',
    ...
    'subscriptions_account_upgrade_title' => 'Mettez à niveau test aujourd’hui et ayez des relations encore plus significatives.',
    'subscriptions_account_upgrade_choice' => 'Choisissez une offre ci-dessous et rejoignez plus de :customers personnes qui ont mis à niveau leur test.',
    ...
    'subscriptions_downgrade_thanks' => 'Merci beaucoup d’avoir essayé l’offre payante. Nous continuons à apporter de nouvelles fonctionnalités sur test tout le temps – vous pouvez donc revenir à l’occasion pour voir si vous pourriez à nouveau être intéressé·e pour prendre un abonnement.',
    ...
    'subscriptions_help_opensource_desc' => 'test est un projet open source. Il est le fruit du travail d’une communauté de bénévoles qui veulent juste fournir un outil pour le bien de tous. Être un projet open source signifie que le code est disponible pour tous sur GitHub, et que tout le monde peut l’inspecter, le modifier et l’améliorer. Tout l’argent que nous récoltons sert uniquement à créer des fonctionnalités, avoir plus de serveurs puissants, aider à payer les factures. Merci pour votre aide. Nous ne pourrions rien faire sans vous – littéralement.',
    ...
    'subscriptions_help_discounts_desc' => 'En effet ! test est gratuit pour les étudiants, les organismes sans but lucratif et les organismes de bienfaisance. Il suffit de contacter le <a href=":support">support</a> avec un justificatif de votre statut et nous allons appliquer ce statut spécial dans votre compte.',
    ...
    'api_description' => 'L’API peut être utilisée pour manipuler les données de test depuis une application externe, comme une application mobile par exemple.',
    ...
    'api_endpoint' => 'Le point de terminaison de l’API pour cette instance test est :',
    ...
    'personalization_title' => 'Ici vous pouvez configurer les différents paramètres de votre compte. Ces fonctionnalités sont pour les « utilisateurs avancés » qui veulent un contrôle maximal sur test.',
