...
return [
    ...
    'confirmation_email_title' => 'test - تأكيد البريد الإلكتروني',
    ...
    'password_reset_title' => 'test – Reset Password Notification',
    ...
    'invitation_title' => 'test – You are invited by :name',
    'invitation_intro' => 'You’ve been invited by :name (:email) to use test, a nice Personal Relationship Management tool.',
