...
return [
    ...
    'export_sql_explanation' => 'تصدير بياناتك في صيغة SQL يسمح لك بأخذ بياناتك و إستيرادها لنموذج test الخاص بك. هذا الأمر قيم فقط إذا كان لديك خادم خاص بك.',
    ...
    'users_list_invitations_explanation' => 'فيما يلي الأشخاص الذين قمتَ بدعوتهم للإنضمام إلى test كمتعاون.',
    ...
    'subscriptions_account_upgrade_title' => 'قم بترقية test اليوم و احصل على علاقات أكثر أهمية.',
    'subscriptions_account_upgrade_choice' => 'اختر خطة أدناه و انضم إلى :customers الأشخاص الذين قاموا بترقية test الخاص بهم.',
    ...
    'subscriptions_downgrade_thanks' => 'شكراً جزيلاً لك لتجربة الخطة المدفوعة. نحن نواصل الإستمرار بإضافة ميزات جديدة في test - لذا قد تريد العودة في المستقبل لترى إذا كنتَ مهتماً بالإشتراك مجدداً.',
    ...
    'subscriptions_help_discounts_desc' => 'نعم لدينا! تطبيق test مجاني للطلاب، و مجاني لأسباب غير ربحية و للمؤسسات الخيرية. فقط تواصل مع <a href=":support">الدعم</a> بدليل على حالتك و سنقوم بتطبيق هذه الحالة الخاصة في حسابك.',
    ...
    'personalization_title' => 'هنا يمكنك إيجاد إعدادات مختلفة لتهيئة حسابك. هذه الميزات تفيد "المستخدمين المميزين" أكثر، الذين يريدون سيطرة قصوى على test.',
