...
return [
    ...
    */
    ...
    'register_title_welcome' => 'مرحبا بك في تطبيق test المثبت حديثاً',
    'register_create_account' => 'يجب أن تنشئ حساباً لتستخدم test',
    'register_title_create' => 'انشئ حسابك لـtest',
