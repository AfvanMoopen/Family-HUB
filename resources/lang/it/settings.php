...
return [
    ...
    'me_help' => 'Questo è il contatto che rappresenta <em>te</em> a test',
    ...
    'export_sql_explanation' => 'Esportare i dati in formato SQL ti permette di importarli nella tua istanza di test. Ciò ha senso solo se hai un tuo proprio server.',
    'export_sql_cta' => 'Esporta a SQL',
    'export_sql_link_instructions' => 'Nota: <a href=":url">leggi le istruzioni</a> per capire come importare questo file nella tua istanza di test.',
    ...
    'locale' => 'Lingua',
    'locale_help' => 'Vuoi aiutare a tradurre test o ad aggiungere una nuova lingua? Segui <a href=":url" target="_blank" lang="en">questo link per ulteriori informazioni</a>.',
    'locale_ar' => 'Arabo',
    'locale_cs' => 'Ceco',
    'locale_de' => 'Tedesco',
    'locale_en' => 'Inglese',
    ...
    'users_list_invitations_explanation' => 'Qui sotto trovi gli inviti a test come collaboratori.',
    ...
    'subscriptions_account_upgrade_title' => 'Aggiorna test oggi e ottieni relazioni più significative.',
    'subscriptions_account_upgrade_choice' => 'Scegli un piano e unisciti alle :customers persone abbonate a test.',
    ...
    'subscriptions_downgrade_thanks' => 'Grazie infinite per aver provato il piano a pagamento. Continuiamo ad aggiungere nuove funzionalità a test – quindi torna a trovarci in futuro per vedere se può interessarti tornare al piano a pagamento.',
    ...
    'subscriptions_help_discounts_desc' => 'Sì! test è gratuita per studenti, no-profit e organizzazioni di beneficienza. Basta contattare <a href=":support">il supporto clienti</a> con una prova del tuo status, e aggiorneremo il tuo account.',
    ...
    'api_description' => 'L\'API puó essere usata per manipolare le informazioni in test da un\'applicazione esterna, ad esempio da un\'applicazione per smartphone.',
    ...
    'api_endpoint' => 'L\'endpoint API per questa istanza test è:',
    ...
    'personalization_title' => 'Qui puoi trovare diverse impostazioni per personalizzare il tuo account. Queste funzionalità sono pensate per utenti esperti che vogliono massimizzare il loro controllo su test.',
    ...
    'personalization_contact_field_type_modal_delete_description' => 'Rimuovere forma di contatto? Questa azione rimuoverá la forma di contatto da TUTTE le persone nel tuo account di test.',
