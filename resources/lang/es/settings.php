...
return [
    ...
    'me_title' => 'My contact',
    'me_help' => 'This is the contact that represents <em>you</em> in test',
    ...
    'export_sql_explanation' => 'Exportar tus datos en formato SQL te permite tomar tu propia información he importarla en tu propia instancia de test. Esto es valioso solo si tú tienes tu propio servidor.',
    ...
    'locale_help' => 'Do you want to help translating test or add a new language? Please follow <a href=":url" target="_blank" lang="en">this link for more information</a>.',
    'locale_ar' => 'Árabe',
    'locale_cs' => 'Checo',
    'locale_de' => 'Alemán',
    'locale_en' => 'Ingles',
    ...
    'users_list_invitations_explanation' => 'Below are the people you’ve invited to join test as a collaborator.',
    ...
    'subscriptions_account_upgrade_title' => 'Upgrade test today and have more meaningful relationships.',
    'subscriptions_account_upgrade_choice' => 'Pick a plan below and join over :customers persons who upgraded their test.',
    ...
    'subscriptions_downgrade_thanks' => 'Thanks so much for having tried the paid plan. We keep adding new features on test all the time – so you might want to come back in the future to see if you might be interested in taking a subscription again.',
    ...
    'subscriptions_help_opensource_desc' => 'test is an open source project. This means it is built by an entirely benevolent community who just wants to provide a great tool for the greater good. Being open source means the code is publicly available on GitHub, and everyone can inspect it, modify it or enhance it. All the money we raise is dedicated to build better features, have more powerful servers, help pay the bills. Thanks for your help. We couldn’t do it without you – literally.',
    ...
    'subscriptions_help_discounts_desc' => 'We do! test is free for students, and free for non-profits and charities. Just contact <a href=":support">the support</a> with a proof of your status and we’ll apply this special status in your account.',
    ...
    'api_description' => 'The API can be used to manipulate test’s data from an external application, like a mobile application for instance.',
    ...
    'api_endpoint' => 'The API endpoint for this test instance is:',
    ...
    'personalization_title' => 'Here you can find different settings to configure your account. These features are more for “power users” who want maximum control over test.',
