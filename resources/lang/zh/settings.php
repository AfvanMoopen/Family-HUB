...
return [
    ...
    'export_sql_explanation' => '以 SQL 格式导出数据使您可以将数据导入到自己的test实例中。这只在你有自己的服务器时有效。',
    ...
    'locale' => '应用程序中使用的语言',
    'locale_help' => '您想要帮助翻译test或添加新语言吗？请点击 <a href=":url" target="_blank" lang="en">了解更多信息</a>。',
    'locale_ar' => '阿拉伯文',
    'locale_cs' => '捷克文',
    'locale_de' => '德文',
    'locale_en' => '英文',
    ...
    'subscriptions_account_upgrade_title' => '立即升级您的test账户吧！',
    ...
    'subscriptions_downgrade_thanks' => '非常感谢您尝试过高级版订阅。我们一直为test不断地增加新的功能-, 期待您的再次订阅。',
    ...
    'subscriptions_help_opensource_desc' => 'test是一个开源项目，这意味着它是由社区建造的项目。开源意味着代码在 GitHub 上公开提供, 每个人都可以检查并修改它。我们筹集的所有资金都致力于建立更好的功能, 拥有更强大的服务器, 帮助支付账单。没有您的支持，我们将无法完成这一切。',
    ...
    'subscriptions_help_discounts_desc' => '当然！test免费为学生，非盈利机构提供服务。您只需要提交一下材料给我们的 <a href=":support">支持人员</a>。',
    ...
    'personalization_title' => '在这里您可以找到不同的设置来配置您的帐户。这些功能更多的是针对想最大化控制test "高级用户"所设置。',
