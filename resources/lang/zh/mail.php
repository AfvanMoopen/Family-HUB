...
return [
    ...
    'confirmation_email_title' => 'test – Email 认证',
    ...
    'password_reset_title' => 'test — 重置密码通知',
    ...
    'invitation_title' => 'test — 您收到 :name 的邀请',
    'invitation_intro' => '您已被:name (:email)邀请使用 test, 个人社交关系管理工具。',
