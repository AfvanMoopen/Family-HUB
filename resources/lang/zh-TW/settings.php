...
return [
    ...
    'export_sql_explanation' => '以 SQL 格式匯出資料使您可以將資料匯入到自己的 test 例項中。這隻在你有自己的伺服器時有效。',
    ...
    'locale' => '應用程式中使用的語言',
    'locale_help' => '您想要幫助翻譯test或新增新語言嗎？請點選 <a href=":url" target="_blank" lang="en">瞭解更多資訊</a>。',
    'locale_ar' => '阿拉伯文',
    'locale_cs' => '捷克文',
    'locale_de' => '德文',
    'locale_en' => '英文',
    ...
    'subscriptions_account_upgrade_title' => '立即升級您的test賬戶吧！',
    ...
    'subscriptions_downgrade_thanks' => '非常感謝您嘗試過高階版訂閱。我們一直為test不斷地增加新的功能-, 期待您的再次訂閱。',
    ...
    'subscriptions_help_opensource_desc' => 'test是一個開源專案，這意味著它是由社群建造的專案。開源意味著程式碼在 GitHub 上公開提供, 每個人都可以檢查並修改它。我們籌集的所有資金都致力於建立更好的功能, 擁有更強大的伺服器, 幫助支付賬單。沒有您的支援，我們將無法完成這一切。',
    ...
    'subscriptions_help_discounts_desc' => '當然！test免費為學生，非盈利機構提供服務。您只需要提交一下材料給我們的 <a href=":support">支援人員</a>。',
    ...
    'personalization_title' => '在這裡您可以找到不同的設定來配置您的帳戶。這些功能更多的是針對想最大化控制test "高階使用者"所設定。',
