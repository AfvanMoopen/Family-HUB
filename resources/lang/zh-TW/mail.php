...
return [
    ...
    'confirmation_email_title' => 'test – Email 認證',
    ...
    'password_reset_title' => 'test — 重置密碼通知',
    ...
    'invitation_title' => 'test — 您收到 :name 的邀請',
    'invitation_intro' => '您已被:name (:email)邀請使用 test, 個人社交關係管理工具。',
