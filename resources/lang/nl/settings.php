...
return [
    ...
    'me_help' => 'Dit is het contact dat <em>jou</em> vertegenwoordigt in test',
    ...
    'export_sql_explanation' => 'Het exporteren van je gegevens in SQL formaat maakt het mogelijk om je gegevens te importeren in je eigen test installatie. Dit is alleen waardevol als je een eigen server hebt.',
    ...
    'locale' => 'Taal',
    'locale_help' => 'Wil je helpen met het vertalen van test of een nieuwe taal toevoegen? <a href=":url" target="_blank" lang="en">Klik hier voor meer informatie.</a>',
    'locale_ar' => 'Arabisch',
    ...
    'subscriptions_account_upgrade_title' => 'Upgrade test vandaag en maak je persoonlijke relaties betekenisvoller.',
    'subscriptions_account_upgrade_choice' => 'Kies hieronder een abonnement en sluit je aan bij meer dan :customers personen die reeds de premium versie van test gebruiken.',
    ...
    'subscriptions_help_discounts_desc' => 'Jazeker! test is gratis voor studenten en goede doelen. Neem contact op met <a href=":support">support</a> met een passend bewijs (van inschrijving) en wij zullen deze speciale status aan je account toekennen.',
    ...
    'api_description' => 'De API kan worden gebruikt om de gegevens van test te gebruiken in een externe applicatie. Bijvoorbeeld een app op je mobiele telefoon.',
    ...
    'api_endpoint' => 'De \'API endpoint\' voor deze test-server is:',
    ...
    'personalization_title' => 'Hier vind je verschillende instellingen voor je account. Deze functies zijn gericht op ervaren gebruikers die maximale controle over test willen hebben.',
