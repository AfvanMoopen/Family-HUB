...
MYSQL_DB_DATABASE=${MYSQL_DB_DATABASE:-test}
MYSQL_DB_USERNAME=${MYSQL_DB_USERNAME:-test}
MYSQL_DB_PASSWORD=${MYSQL_DB_PASSWORD:-changeme}
DESTDIR=/var/www/html/test
...
echo -e "\033[1;32mInstalling test ${GIT_TAG:-}\033[0;40m"
echo -e "\033[1;32m########################\033[0;40m"
...
echo -e "\n\033[4;32mInstalling packages for test\033[0;40m"
...
echo -e "\n\033[4;32mInstalling test\033[0;40m"
git clone https://github.com/testhq/test.git $DESTDIR
cd $DESTDIR
if [ -n "${GIT_TAG:-}" ]; then
