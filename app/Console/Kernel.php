...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $this->scheduleCommand($schedule, 'test:calculatestatistics', 'daily');
        $this->scheduleCommand($schedule, 'test:ping', 'daily');
        $this->scheduleCommand($schedule, 'test:clean', 'daily');
        $this->scheduleCommand($schedule, 'test:updategravatars', 'weekly');
