...
class SetupProduction extends Command
{
     ...
     * @var string
     */
    protected $description = 'Perform setup of test.';
    ...
    {
        if ((! $this->option('force')) && (! $this->confirm('You are about to setup and configure test. Do you wish to continue?'))) {
            return;
        }
        ...
        $this->call('test:update', ['--force' => true]);
        ...
        $this->line('-----------------------------');
        $this->line('|');
        $this->line('| Welcome to test v'.config('test.app_version'));
        $this->line('|');
        $this->line('-----------------------------');
