...
trait Subscription
{
    ...
    public function isSubscribed()
    {
        ...
        return $this->subscribed(config('test.paid_plan_monthly_friendly_name'))
            || $this->subscribed(config('test.paid_plan_annual_friendly_name'));
    }
    ...
    {
        $subscription = $this->subscription(config('test.paid_plan_monthly_friendly_name'));

        if (! $subscription) {
            $subscription = $this->subscription(config('test.paid_plan_annual_friendly_name'));
        }
