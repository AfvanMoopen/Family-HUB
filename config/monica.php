...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This is used to indicate which version of test you are running. You
    ...
    */
    ...
    | version.testhq.com to check if a new version is available.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Your test instance has some statistics (number of users, number of
    | contacts,...). Those data can be public (they are on testHQ.com).
    ...
    */
    ...
    |
    */
    'weekly_ping_server_url' => 'https://version.testhq.com/ping',
    ...
    */
    ...
    | are available on https://testhq.com, for free.
    ...
    */
    ...
    | on https://testhq.com. These settings make sense only if you do activate
    ...
    */
    ...
    |
    */
    'support_email_address' => env('SUPPORT_EMAIL_ADDRESS', 'support@testhq.com'),
    ...
    |
    */
    'twitter_account' => env('SUPPORT_TWITTER', 'testHQ_app'),
